...
- Use the standardized stack: **Vite + Vue 3 + TypeScript + Pinia** frontend, **FastAPI + uvicorn + Python (uv)** backend, and **SQLite** database. These are pre-validated and optimized for local sandbox environments.
